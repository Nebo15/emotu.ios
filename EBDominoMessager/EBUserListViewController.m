...
@interface EBUserListViewController ()
...
@implementation EBUserListViewController
...
- (void)viewDidLoad
{
    ...
    self.conversationVC = [DMConversationViewController new];
